...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.api.att.js')
	...
	f = os.path.join(cwd,'Classes','TiApiAttModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.api.att.js']
